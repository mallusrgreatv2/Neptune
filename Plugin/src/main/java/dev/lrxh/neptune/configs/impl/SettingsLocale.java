...
public enum SettingsLocale implements IDataAccessor {
    ...
    ARENA_COPY_OFFSET_X("ARENA.COPY_OFFSET.X", "The offset in the X direction when duplicating an arena. (This value most be dividable by 16)", DataType.INT,
            "496"),
    ARENA_COPY_OFFSET_Z("ARENA.COPY_OFFSET.Z", "The offset in the Z direction when duplicating an arena. (This value most be dividable by 16)", DataType.INT,
            "0"),
