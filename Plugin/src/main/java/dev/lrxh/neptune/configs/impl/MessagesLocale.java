...
public enum MessagesLocale implements IDataAccessor {
        ...
        YOU_CANT_SEND_DUEL("DUEL.YOU_CANT_SEND_DUEL", DataType.STRING_LIST,
                        "&cYou can't send duel requests right now!"),
        ...
        PARTY_ALREADY_SENT("PARTY.ALREADY_SENT", DataType.STRING_LIST,
                        "&cYou have already sent <player> a party request."),
        ...
        PARTY_ADVERTISE_JOIN_HOVER("PARTY.ADVERTISE.JOIN_HOVER", DataType.STRING,
                        "&aClick to join &f<leader>&a's party."),
        PARTY_KICK("PARTY.KICK", DataType.STRING_LIST, "&f<player> &bhas been kicked from the party."),
        PARTY_CANNOT_CREATE("PARTY.CANNOT_CREATE", DataType.STRING_LIST,
                        "&cYou can only create a party while in lobby!"),
        ...
        PARTY_MAX_SIZE_SETTING("PARTY.MAX_SIZE_SETTING_REACHED", DataType.STRING_LIST,
                        "&cThis party can only have a size limit of <max> players!"),
        ...
        IN_MATCH_BLOCKED_COMMAND_MESSAGE("IN_MATCH_BLOCKED_COMMAND", DataType.STRING_LIST,
                        "&cThis command is blocked while in a match!"),
                ...
                if (dataType.equals(DataType.STRING_LIST)) {
                        for (String message : getStringList()) {
                                if (message.equals("NONE"))
                                        continue;
                                PlayerUtil.sendMessage(playerUUID,
                                                CC.returnMessage(player, message, replacements));
                        }
