...
public enum MessagesLocale implements IDataAccessor {
    ...
    QUEUE_JOIN("QUEUE.JOIN", DataType.STRING_LIST, "&7(&bDuels&7) Joined queue for <kit>"),
    QUEUE_LEAVE("QUEUE.LEAVE", DataType.STRING_LIST, "&7(&bDuels&7) Left queue for <kit>"),
    QUEUE_ACTION_BAR("QUEUE.ACTION_BAR", DataType.STRING, "&7<kit> 1v1 &8| &a<time>"),
    QUEUE_MULTI_QUEUE_ACTION_BAR("QUEUE.MULTI_QUEUE.ACTION_BAR", DataType.STRING, "&7<kits> 1v1 &8| &a<time>"),
