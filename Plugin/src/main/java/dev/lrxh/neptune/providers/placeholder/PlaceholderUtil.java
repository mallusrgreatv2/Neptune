        ...
        if (match != null) {
            ...
            if (match instanceof SoloFightMatch sfm) {
                ...
                placeholders = TagResolver.resolver(placeholders,
                    ...
                    TagResolver.resolver("name-colored", match.getColoredNameResolver(participant)),
                    ...
                    TagResolver.resolver("opponent-colored", match.getColoredNameResolver(opponent)),
                    ...
                    TagResolver.resolver("red-name-colored", match.getColoredNameResolver(red)),
                    ...
                    TagResolver.resolver("blue-name-colored", match.getColoredNameResolver(blue)),
